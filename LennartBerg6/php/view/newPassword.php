...
<div class="main">
    ...
    <div class="acitvationContainer">
        ...
        <p>You will soon (1 minute later) receive a mail containing your personal activation code. If you already
            ...
            below. If you forget to activate your account, you can request a new activation code by just re-requesting
        ...
        <form action="newPasswordAction.php" method="POST">
            <div class="registry-success-form">
                ...
                <input type="password" id="passwordRepeat" name="passwordRepeat" placeholder="Repeat your new password"
                       required> <br> <br>
            </div>
            <div class="buttons">
