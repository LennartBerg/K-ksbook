...
?>
<link rel="stylesheet" type="text/css" href="./assets/css/friedTofu.css">
</head>
<body>
...
<div class="main">
    <div class="RecipeShortInfo">
        ...
        <div>
            <a href=" viewRecipe.php?recipeID=<?php echo $recipe->getRecipeID(); ?>"><img class="previewPicture"
                                                                                          src="<?php echo $recipe->getPicturePath(); ?>"
                                                                                          alt= <?= "Picture of " . htmlspecialchars($recipe->getName()); ?>></a>
        </div>
    </div>
            ...
            <noscript>
                <form class="rating" action="./addRating.php" method="post">
                    ...
                    <select class="select-multi" name="rating" id="rating" required>
                        <option value="1" <?php if (htmlspecialchars($rating == 1)) echo 'selected'; ?>>1 Star</option>
                        <option value="2" <?php if (htmlspecialchars($rating == 2)) echo 'selected'; ?>>2 Stars</option>
                        <option value="3" <?php if (htmlspecialchars($rating == 3)) echo 'selected'; ?>>3 Stars</option>
                        <option value="4" <?php if (htmlspecialchars($rating == 4)) echo 'selected'; ?>>4 Stars</option>
                        <option value="5" <?php if (htmlspecialchars($rating == 5)) echo 'selected'; ?>>5 Stars</option>
                    </select>
...
<div id="rating" ratingvalue="<?php echo htmlspecialchars($rating); ?>"></div>
