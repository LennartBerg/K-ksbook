...
<main>
    <section>
        ...
        <?php elseif (isset($_SESSION["message"]) && $_SESSION["message"] == "user_deleted"): ?>
            <p class="GreenNotification">
                User deleted! All your recipes, ratings and comments have been deleted as well. You have been logged
                out,
                too.
            </p>
            ...
            <form action="filter.php" method="GET">
                ...
                <div>
                    ...
                    <select class="select-multi" name="meal-type-filter" id="meal-type-filter">
                        ...
                        <option value="breakfast" <?php if ($mealTypeFilter == 'breakfast') echo 'selected'; ?>>
                            Breakfast
                        </option>
                        <option value="lunch" <?php if ($mealTypeFilter == 'lunch') echo 'selected'; ?>>Lunch</option>
                        <option value="dinner" <?php if ($mealTypeFilter == 'dinner') echo 'selected'; ?>>Dinner
                        </option>
                ...
                <div>
                    ...
                    <select class="select-multi" name="work-time-filter" id="work-time-filter">
                        ...
                        <option value="15" <?php if ($workTimeFilter == '15') echo 'selected'; ?>>Up to 15 minutes
                        </option>
                        <option value="30" <?php if ($workTimeFilter == '30') echo 'selected'; ?>>Up to 30 minutes
                        </option>
                        <option value="60" <?php if ($workTimeFilter == '60') echo 'selected'; ?>>Up to 60 minutes
                        </option>
